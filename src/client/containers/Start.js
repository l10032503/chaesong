            ...
            <div>
                    ...
                    <div className="container h-100">
                        <div className="row h-100 align-items-center justify-content-center text-center">
                            <div class="col-lg-10 align-self-end">
                                <h1 class="text-white">똑똑한 채식의 시작, 채송</h1>
                            ...
                            <div class="col-lg-8 align-self-baseline">
                                ...
                                <a className="btn btn-success btn-xl" href="login" >회원가입 및 로그인</a>
                            </div>
                        </div>
                    </div>
                </header>
                ...
                <section className="page-section-1" id="services">
                    <div className="container">
                        <h2 className="text-center mt-0">내 몸에 부족한 영양소 한눈에 알고 싶을 때,</h2>
                        <hr className="divider my-4"/>
                            <p className="text-center text-black-50 mb-4">하루 필수영양소와 섭취한 영양소를 비교해 <br/>
                                영양소의 균형을 맞추기 위한 레시피 추천해드립니다</p>
                            <div className="row">
                                <div className="col-lg-4 col-md-12 text-center">
                                    <div className="mt-5">
                                        <i className="fas fa-4x fa-pizza-slice mb-4" />
                                        <h3 className="h4 mb-3">Step 1</h3>
                                        <p className="text-muted mb-0">오늘 먹은 음식을<br/>채송을 통해 손쉽게 기록한다!</p>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-md-12 text-center">
                                    <div className="mt-5">
                                        <i className="fas fa-4x fa-chart-bar mb-4" />
                                        <h3 className="h4 mb-3">Step 2</h3>
                                        <p className="text-muted mb-0">채송그래프를 통해 내 몸에<br/>부족한 영양소를 확인한다!</p>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-md-12 text-center">
                                    <div className="mt-5">
                                        <i className="fas fa-4x fa-thumbs-up mb-4" />
                                        <h3 className="h4 mb-3">Step 3</h3>
                                        <p className="text-muted mb-0">채송만의 추천 알고리즘으로<br/>내몸에 꼭 맞는 식단을 추천받는다!</p>
                                    </div>
                                </div>
                            </div>
                    </div>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8 text-center">
                                <h2 class="text-white mt-0">내가 피하는 재료 손쉽게 거르고 싶을 때,</h2>
                                <hr class="divider light my-4"/>
                                    <p class="text-white-50">선택한 다섯종류 채식 타입에 따른 자동 필터링 기능과<br/>
                            ...
                            <div className="col-lg-4 col-sm-6">
                                ...
                                <img className="img-fluid" src="https://i.imgur.com/qaeo43b.png" alt=""/>
                                    <div className="portfolio-box-caption">
                                        <div className="project-category text-white-75">
                                            5가지 채식타입 세분화
                                        </div>
                ...
                <section class="page-section-1 bg-light text-black-50">
                    <div class="container text-center">
                        <h2 class="mb-4">이제 채송으로 똑똑한 식단관리 시작해볼까요? </h2>
